...
const AboutSection = () => {
  return (
    <section className="container-fluid py-3 py-md-5" id="about">
      <div className="container">
        <div className="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
          <div className="col-12 col-lg-6 col-xl-5" data-aos="fade-right">
            <img
              className="img-fluid rounded"
              loading="lazy"
              src="https://media.istockphoto.com/id/1368965646/photo/multi-ethnic-guys-and-girls-taking-selfie-outdoors-with-backlight-happy-life-style-friendship.webp?b=1&s=612x612&w=0&k=20&c=8varqjy2VLQHBm658rl2hS7MMakLA5iXd7Qvr7L8bx4="
              alt="About 1"
            />
          </div>
          <div className="col-12 col-lg-6 col-xl-7">
            <div className="row justify-content-xl-center">
              <div className="col-12 col-xl-11">
                <h2 className="mb-3" data-aos="fade-down">Who Are We?</h2>
                <p className="lead fs-4 text-secondary mb-3" data-aos="fade-down">
